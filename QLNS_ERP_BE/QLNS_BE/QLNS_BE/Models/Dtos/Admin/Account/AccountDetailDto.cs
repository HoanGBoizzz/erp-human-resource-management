...
{/// <summary>
 /// Chi tiết tài khoản (Admin/Giám đốc).
 /// </summary>
    public class AccountDetailDto
    {
        ...
        public DateTime CreatedAt { get; set; }              // TAI_KHOAN.created_at
        public DateTime UpdatedAt { get; set; }              // TAI_KHOAN.updated_at

        /// <summary>
        /// true nếu có thể xem mật khẩu tạm (chưa đăng nhập lần đầu)
        /// </summary>
